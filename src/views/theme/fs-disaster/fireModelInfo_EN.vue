<template>
  <div class="full fullRight">
    <div class="fire_title">Information of disaster model cluster</div>
    ...
    <div class="fire_con OptimizationView">
      <div class="Optimization zkb_scrollbar">
        ...
        <div class="right-select">
          ...
          <el-select v-model="DisasterVal" placeholder="请选择">
            <el-option
        ...
        <div class="right-select">
          ...
          <el-select v-model="FunctionVal" placeholder="请选择">
            <el-option
        ...
        <div class="bottom_btn">
          <div class="btn_item" @click="submit">Register my model</div>
        </div>
      </div>
...
export default class fireModelInfo_EN extends Vue {
  ...
  private DisasterVal = '10600 Fire'
  private FunctionList = [{
    value: '1',
    label: '01 Simulation'
  }]
  private FunctionVal = '01 Simulation'
  private addressUrl = 'Https://......'
  private mounted() {
    if (this.defaultData) {
...
@img2: "../../../assets/img";
.fire_title {
  background: url(~"@{img2}/fireView/studyJudge/smalltitle.png") no-repeat bottom left;
  height: 50px;
...
.OptimizationView {
  ...
  .bottom_btn {
    ...
    .btn_item {
      width: 210px;
      height: 50px;
      background: url(~"@{img2}/fireView/nor.png") no-repeat center center;
      ...
      &:hover,
      &:active {
        background: url(~"@{img2}/fireView/sel.png") no-repeat center center;
